...
class TestBurger:
    def test_buns_are_set_correctly(self):
        bun = Mock(spec=Bun)
        burger = Burger()
        burger.set_buns(bun)
        assert burger.bun == bun

    def test_ingredient_is_added_correctly(self):
        ingredient = Mock(spec=Ingredient)
        burger = Burger()
        burger.add_ingredient(ingredient)
        assert ingredient in burger.ingredients

    def test_ingredient_is_removed_correctly(self):
        ingredient = Mock(spec=Ingredient)
        burger = Burger()
        burger.add_ingredient(ingredient)
    ...
    def test_ingredient_is_moved_correctly(self):
    ...
    def test_receipt_is_generated_correctly(self):
        bun = Mock(spec=Bun)
